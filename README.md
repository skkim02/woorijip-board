<div align="center">
  ...
  <h1>우리집 보드</h1>
  <p>버튼으로 부탁하고, 버튼으로 끝내요 — 부부를 위한 집안일·요청 보드</p>
</div>
...
**우리집 보드**는 부부(와이프·남편)가 서로에게 집안일이나 사다 줄 것을 가볍게 부탁하고
처리 상황을 공유하는 모바일 웹앱입니다.

- 🥛 자주 쓰는 요청(우유·빵·계란·휴지·쓰레기)은 버튼 한 번으로 올리기
- 🔄 요청 → **내가 할게**(맡음) → **완료** 의 간단한 흐름
- ⏰ 기한 설정, 기한순/요청순 정렬
- 📲 상대가 요청·맡음·완료하면 **푸시 알림** (앱을 닫아둬도 옴)
- 📡 두 사람 화면이 **실시간 동기화** (새로고침 불필요)
...
1. 추가된 앱을 엽니다.
2. 상단에서 **본인(와이프/남편)** 을 선택합니다. → 이 기기에 기억됩니다.
